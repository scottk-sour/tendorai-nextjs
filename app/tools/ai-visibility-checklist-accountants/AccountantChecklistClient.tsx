...
function getScoreBand(count: number) {
  ...
  if (count <= 20) return { label: 'Strong \u2014 well-positioned for AI recommendations', color: 'text-blue-600', bg: 'bg-blue-50 border-blue-200', cta: { label: 'Run Your AI Visibility Report', href: '/aeo-report' } };
  return { label: 'Excellent \u2014 your practice is optimised for AI discovery', color: 'text-green-600', bg: 'bg-green-50 border-green-200', cta: { label: 'Check Your AI Visibility', href: '/aeo-report' } };
}
