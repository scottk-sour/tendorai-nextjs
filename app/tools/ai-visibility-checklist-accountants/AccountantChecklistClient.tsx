...
function getScoreBand(count: number) {
  ...
  if (count <= 16) return { label: 'Developing \u2014 some signals present but significant gaps remain', color: 'text-amber-600', bg: 'bg-amber-50 border-amber-200', cta: { label: 'See the TendorAI programme', href: '/ai-visibility-platform' } };
