...
const CTA_URL =
  '/aeo-report?utm_source=ai-visibility-for-accountants&utm_medium=landing&utm_campaign=accountants-cluster&utm_content=primary-cta';
...
const faqs: Array<{ q: string; a: string }> = [
  {
    q: 'Does ICAEW or ACCA membership automatically mean AI assistants will recommend my firm?',
    a: 'No. ICAEW chartered and ACCA chartered certified status is necessary but not sufficient. AI engines need the firm’s membership data structured and machine-readable on the firm’s own website, consistent with the ICAEW or ACCA register and Companies House. The registers themselves are rarely cited directly by AI engines as a recommendation source.',
  },
  {
    q: 'What’s the difference between ICAEW and ACCA for AI visibility purposes?',
    a: 'ICAEW members are chartered accountants and ACCA members are chartered certified accountants — they are separate professional bodies with separate registers and separate designatory letters (ACA versus ACCA). For AI visibility, the firm should declare whichever applies on its own website and link to the correct register entry. Conflating the two on a firm profile reduces the engine’s confidence in the firm’s identity.',
  },
  {
  ...
  {
    q: 'Which AI platforms cite UK accountants most consistently in 2026?',
  ...
  },
  {
    ...
    a: 'No. TendorAI is an AI visibility platform, not a source of tax or accounting advice and not an outcome guarantee. The platform installs the structured signals AI engines use, audits the gaps and tracks citation frequency — but AI engine behaviour is platform-specific and changes over time.',
  },
  {
    q: 'Can I implement this without using TendorAI?',
    a: 'Yes. Schema.org JSON-LD, a structured website, consistent ICAEW or ACCA register and Companies House entries and an active citation programme can be implemented manually. TendorAI automates the work and tracks the outcome — the citation gains are available either way.',
  },
];
...
export default function AccountantsAiVisibilityPage() {
  const articleJsonLd = {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(accountingServiceJsonLd) }} />

      <main className="min-h-screen bg-white">
        {/* Hero */}
        <section className="bg-brand-gradient text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-xs uppercase tracking-[0.2em] text-white/80 mb-3">UK Accountants · ICAEW chartered &amp; ACCA chartered certified</p>
        ...
        {/* H2-1 What is AI visibility for accountants? */}
        ...
        {/* H2-2 Why are most ICAEW/ACCA firms invisible? */}
        <section className="py-10 md:py-14">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5 text-gray-700 leading-relaxed">
            ...
            <p>
              On TendorAI&rsquo;s own AI visibility score — independently tracked by Searchable.com — the move from 22.2% to 61.1% in four days (19 to 23 May 2026) was driven by structured, dated content. Most UK accountancy practices are missing that structured layer entirely.
            </p>
            <p>
              The single most common cause is the absence of machine-readable schema on the firm&rsquo;s own website. A polished site with five service pages in plain prose is not the same as a site that declares AccountingService schema with ICAEW or ACCA membership number, named principals and services declared in JSON-LD. AI engines cannot reliably extract entity claims from prose; they read structured data first.
            </p>
            <p>
              The second common cause is identity inconsistency. When a firm&rsquo;s trading name on the website, its ICAEW or ACCA register entry, its Companies House record and its Google Business Profile do not match, the engine cannot resolve the firm as a single entity. AI engines that cannot confidently identify a firm tend to name a competitor with cleaner signals instead.
            </p>
            <p>
            ...
            <p>
              None of these gaps reflect quality of accounting work. They reflect how findable, verifiable and consistent the firm&rsquo;s identity is across the public web.
            </p>
          </div>
        </section>

        {/* H2-3 How does TendorAI get an accountant cited? */}
        <section className="py-10 md:py-14 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5 text-gray-700 leading-relaxed">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900" style={{ fontFamily: 'var(--font-serif)' }}>
            ...
            <p>
              Engineering installs Schema.org JSON-LD — AccountingService, Person entries for ICAEW or ACCA-qualified principals, Service entries for self-assessment, corporation tax, VAT and payroll — on the firm&rsquo;s website. Listings audits the UK directories AI assistants cross-reference and flags where the firm is missing, or where its name, address or phone do not match.
            </p>
            <p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 max-w-5xl mx-auto">
              {CITIES.map((city) => (
                <Link
                  key={city.slug}
                  href={`/ai-visibility-for-accountants/${city.slug}`}
        ...
        <section className="py-8 bg-gray-50 border-t border-gray-200">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-xs text-gray-500">
              TendorAI is an AI visibility platform. It is not a source of tax or accounting advice. No outcome guarantees are made or implied.
            </p>
          </div>
        </section>
      </main>
