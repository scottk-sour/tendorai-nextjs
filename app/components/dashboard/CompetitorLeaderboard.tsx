...
const SOLICITOR_PLACEHOLDER: CompetitorData = {
  ...
  topCompetitors: [
    { name: 'Hugh James Solicitors', mentionCount: 12, website: 'https://www.hughjames.com' },
    { name: 'Acuity Law', mentionCount: 11, website: 'https://www.acuitylaw.com' },
    { name: 'Darwin Gray', mentionCount: 10, website: 'https://www.darwingray.com' },
    { name: 'Geldards LLP', mentionCount: 9, website: 'https://www.geldards.com' },
    { name: 'Blake Morgan', mentionCount: 8, website: 'https://www.blakemorgan.co.uk' },
  ],
