          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className={`relative h-48 bg-gradient-to-br ${service.fallbackColor}`}>
                ...
                {/* Hover Overlay */}
                <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-indigo-700 opacity-0 group-hover:opacity-90 transition-opacity duration-300 flex items-center justify-center">
