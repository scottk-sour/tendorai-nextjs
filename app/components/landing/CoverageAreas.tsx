      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            <h3 className="text-xl font-bold text-blue-900 mb-4">South Wales</h3>
          ...
          {/* South West Coverage */}
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            <h3 className="text-xl font-bold text-blue-900 mb-4">South West England</h3>
            <p className="text-gray-600 leading-relaxed mb-6">
          ...
          {/* Supplier CTA */}
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
            <h3 className="text-xl font-bold text-blue-900 mb-4">Are You a Supplier?</h3>
            <p className="text-gray-600 leading-relaxed mb-6">
            ...
            <Link
              href="/for-vendors"
              className="inline-flex items-center gap-2 text-blue-800 font-semibold border-2 border-blue-800 px-5 py-2.5 rounded-lg hover:bg-blue-800 hover:text-white transition-all"
            >
              List Your Business
