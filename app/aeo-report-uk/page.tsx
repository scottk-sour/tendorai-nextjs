...
export const metadata: Metadata = {
  title: 'AEO Report UK — Free AI Visibility Audit for UK Businesses',
  description:
    'Get a free AEO report for your UK business. See how ChatGPT, Perplexity and Claude see your company. AI Visibility score, competitor analysis and actionable gaps in 60 seconds.',
  alternates: {
  ...
  openGraph: {
    ...
    siteName: 'TendorAI',
    locale: 'en_GB',
    images: [{ url: '/logo.png', width: 873, height: 873, alt: 'TendorAI AEO Report UK' }],
  },
  twitter: {
    card: 'summary',
    title: 'AEO Report UK — Free AI Visibility Audit for UK Businesses',
    description:
      'Get a free AEO report for your UK business. See how ChatGPT, Perplexity and Claude see your company.',
    images: ['/logo.png'],
  },
  robots: {
    index: true,
...
const webPageSchema = {
  ...
  '@type': 'WebPage',
  name: 'AEO Report UK — Free AI Visibility Audit for UK Businesses',
  description:
    'Get a free AEO report for your UK business. See how ChatGPT, Perplexity and Claude see your company. AI Visibility score, competitor analysis and actionable gaps in 60 seconds.',
  url: 'https://www.tendorai.com/aeo-report-uk',
        ...
        <section className="bg-brand-gradient text-white py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              <span className="text-sm font-medium">Free AEO report for UK businesses</span>
            </div>
            <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              AEO Report UK &mdash; Free AI Visibility Audit for UK Businesses
            </h1>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section className="mb-14">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              AEO stands for Answer Engine Optimisation. An AEO report is a comprehensive audit
            ...
            <p className="text-gray-600 leading-relaxed">
              An AEO report tells you exactly where you stand. It queries multiple AI platforms
          ...
          {/* What Does TendorAI's AEO Report Measure? */}
          <section className="mb-14">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
              What Does TendorAI&apos;s AEO Report Measure?
            </h2>
            <p className="text-gray-600 leading-relaxed mb-6">
              TendorAI&apos;s AEO report analyses your business across six key scoring
            ...
            <div className="grid sm:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-purple-50 rounded-xl p-6 border border-purple-100">
                ...
                <p className="text-sm text-purple-700">
                  Your AEO report reveals exactly which competitors AI platforms recommend
          ...
          <section className="mb-14">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
              How an AEO Report Differs From a Traditional SEO Audit
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              SEO and AEO are complementary but fundamentally different disciplines. A
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              An AEO report, by contrast, measures whether AI assistants can find, understand,
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr>
                    ...
                    <th className="text-left py-3 px-4 bg-purple-50 text-sm font-semibold text-purple-700 rounded-tr-lg">AEO Report</th>
                  </tr>
                </thead>
                <tbody>
                  {[
            ...
            <p className="text-gray-600 leading-relaxed">
              Both matter. SEO drives traffic from Google; AEO captures the growing wave of
              users who ask AI for direct answers. The businesses that invest in both will
              dominate their categories. But AEO is where the growth is happening right now
          ...
          <section className="mb-14">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
              What You Get in the Free AEO Report
            </h2>
            <p className="text-gray-600 leading-relaxed mb-6">
              TendorAI&apos;s free AEO report gives you a detailed snapshot of your AI
          ...
          <section className="mb-14">
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-8 md:p-10 text-white text-center">
              ...
              <p className="text-purple-100 mb-6 max-w-lg mx-auto">
                Enter your company name and get your free AEO report in 60 seconds. No signup.
          ...
          <section className="mb-14">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">
              AEO Report UK &mdash; Frequently Asked Questions
            </h2>
          ...
          <section className="border-t border-gray-200 pt-10">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-sm text-gray-500">
                  Read the latest on AI visibility, AEO strategy, and growing your business.
                </p>
              </Link>
              <Link
