...
const faqs: Array<{ q: string; a: string }> = [
  {
    q: 'Does FCA authorisation automatically mean AI assistants will recommend my firm?',
    a: 'No. FCA authorisation — whether your firm is directly authorised (DA) or an appointed representative (AR) of a principal firm — is necessary but not sufficient. AI engines need the firm’s FCA permission data structured and machine-readable on the firm’s own website, consistent with the FCA Register and Companies House. The Register itself is rarely cited directly by AI engines as a recommendation source.',
  },
  {
    q: 'What’s the difference between directly authorised and appointed representative for AI visibility?',
    a: 'A directly authorised firm holds its own FCA permission to give mortgage advice. An appointed representative (AR) operates under the FCA permission of a principal firm, which is responsible for the AR’s regulated activities. For AI visibility, both forms need to declare their actual regulatory status clearly on their website — an AR misdeclaring itself as DA, or vice versa, reduces the engine’s confidence in the firm’s identity.',
  },
  {
  ...
  {
    q: 'Which AI platforms cite UK mortgage advisers most consistently in 2026?',
  ...
  },
  {
    ...
    a: 'No. TendorAI is an AI visibility platform, not a source of mortgage advice and not an outcome guarantee. The platform installs the structured signals AI engines use, audits the gaps and tracks citation frequency — but AI engine behaviour is platform-specific and changes over time.',
  },
  {
    q: 'Can I implement this without using TendorAI?',
    a: 'Yes. Schema.org JSON-LD, a structured website, consistent FCA Register and Companies House entries and an active citation programme can be implemented manually. TendorAI automates the work and tracks the outcome — the citation gains are available either way.',
  },
];
...
export default function MortgageAdvisersAiVisibilityPage() {
  const articleJsonLd = {
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-brand-gradient text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-xs uppercase tracking-[0.2em] text-white/80 mb-3">UK Mortgage Advisers · FCA-regulated</p>
        ...
        {/* H2-1 What is AI visibility for mortgage advisers? */}
        <section className="py-10 md:py-14 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5 text-gray-700 leading-relaxed">
            ...
            <p>
              AI visibility for mortgage advisers is the discipline of making an FCA-regulated firm&rsquo;s permission status, specialisms and credible citations machine-readable, so AI assistants name the firm in answers to recommendation queries. The firms cited consistently in 2026 share the same three signals: Schema.org JSON-LD on the firm&rsquo;s own website, identity consistency across the FCA Register and Companies House, and citations from sources AI engines treat as authoritative for UK mortgage information.
            </p>
            <p>
        ...
        {/* H2-2 Why are most FCA-regulated firms invisible? */}
        <section className="py-10 md:py-14">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5 text-gray-700 leading-relaxed">
            ...
            <p>
              On TendorAI&rsquo;s own AI visibility score — independently tracked by Searchable.com — the move from 22.2% to 61.1% in four days (19 to 23 May 2026) was driven by structured, dated content. Most UK mortgage adviser firms are missing that structured layer entirely.
            </p>
            <p>
              The single most common cause is the absence of machine-readable schema on the firm&rsquo;s own website. A polished site with three or four service pages in plain prose is not the same as a site that declares FinancialService schema with FCA firm reference number, named advisers (with their individual FCA reference numbers) and specialisms declared in JSON-LD. AI engines cannot reliably extract entity claims from prose; they read structured data first.
            </p>
            <p>
              The second common cause is identity inconsistency. When a firm&rsquo;s trading name on the website, its FCA Register entry, its Companies House record and its Google Business Profile do not match — including whether it is shown as a DA firm or as an AR of a named principal — the engine cannot resolve the firm as a single entity. AI engines that cannot confidently identify a firm tend to name a competitor with cleaner signals instead.
            </p>
            <p>
            ...
            <p>
              None of these gaps reflect quality of advice. They reflect how findable, verifiable and consistent the firm&rsquo;s identity is across the public web.
            </p>
          </div>
        </section>

        {/* H2-3 How does TendorAI get a mortgage adviser cited? */}
        <section className="py-10 md:py-14 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5 text-gray-700 leading-relaxed">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900" style={{ fontFamily: 'var(--font-serif)' }}>
            ...
            <p>
              Engineering installs Schema.org JSON-LD — FinancialService, Person entries for FCA-registered advisers, Service entries for residential, buy-to-let, first-time buyer and remortgage advice — on the firm&rsquo;s website. Listings audits the UK directories AI assistants cross-reference and flags where the firm is missing, or where its name, address or phone do not match.
            </p>
            <p>
        ...
        <section className="py-10 bg-white border-t border-gray-200">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 grid sm:grid-cols-3 gap-4 text-sm">
            <Link href="/blog/how-to-get-mortgage-adviser-recommended-by-chatgpt" className="text-purple-700 hover:underline">
              How to get your mortgage adviser business recommended by ChatGPT &rarr;
            </Link>
        ...
        <section className="py-14 bg-white border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">
              AI Visibility for Mortgage Advisers by City
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 max-w-5xl mx-auto">
              {CITIES.map((city) => (
                <Link
                  key={city.slug}
                  href={`/ai-visibility-for-mortgage-advisors/${city.slug}`}
                ...
                >
                  Mortgage advisers in {city.name}
                </Link>
              ))}
            </div>
          </div>
        ...
        <section className="py-8 bg-gray-50 border-t border-gray-200">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-xs text-gray-500">
              TendorAI is an AI visibility platform. It is not a source of mortgage advice. No outcome guarantees are made or implied.
            </p>
          </div>
        </section>
      </main>
