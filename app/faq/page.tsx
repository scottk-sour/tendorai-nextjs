...
const allFaqs = [
    ...
    },
    {
      ...
      answer: "Free to be listed. Paid plans start at £299/month (early adopter price, rising to £599) for full AI visibility including priority ranking, AI Visibility (AEO) reports, and mention tracking.",
    },
    {
    ...
    {
      question: 'Is it free?',
      answer: "Free to be listed with a basic profile. Paid plans from £299/month (early adopter price, rising to £599) give you priority ranking in AI results, pricing visibility, and AI visibility reports.",
    },
    {
    ...
    },
    {
      ...
      answer: "GEO agencies charge £1,500–8,000 per month on 12-month contracts and take 3–6 months to deliver results. TendorAI Pro costs £299/month (early adopter price, rising to £599), has no lock-in, and we install everything within 48 hours. Our data also syncs automatically with your TendorAI profile — agencies require manual updates every time something changes.",
    },
    {
