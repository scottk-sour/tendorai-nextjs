...
const TITLE = 'AI Visibility Report: Bolton Solicitors 2026 — TendorAI Research';
const DESCRIPTION =
...
const faqs = [
  {
    q: 'Does my Bolton firm appear when someone asks AI to recommend a solicitor?',
  ...
  {
    q: 'How many Bolton solicitors are AI-visible?',
    a: 'TendorAI tracks 72 SRA-registered solicitors in Bolton. 14 have no website. Of the remaining 58, the majority have no structured schema data — meaning even firms with websites are likely invisible to AI recommendation engines.',
  },
  {
  ...
  },
  {
    ...
    a: 'For high-intent queries ("find me a solicitor in Bolton"), AI is already answering directly without returning links. According to industry data, AI Overviews now appear in over 60% of searches. Firms not visible in AI responses are missing an increasing share of inbound enquiries.',
  },
  {
...
export default function AIVisibilityReportBoltonSolicitors() {
  ...
  const articleJsonLd = {
    ...
    keywords: [
      'AI visibility solicitors Bolton',
      'Bolton solicitors AI',
      'Bolton law firm AI recommendations',
      'ChatGPT solicitor Bolton',
      'AI visibility report Bolton',
      'solicitor AI discovery Bolton',
    ],
    wordCount: 2400,
    inLanguage: 'en-GB',
  };
        ...
        <section className="bg-gradient-to-br from-[#1B4F72] via-[#1a3d5c] to-[#2d1b4e] text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <nav className="text-sm mb-6 text-blue-200">
              ...
              <span className="mx-2">/</span>
              <span className="text-white">Bolton Solicitors AI Visibility</span>
            </nav>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
              AI Visibility Report: Bolton Solicitors 2026
            </h1>

            <p className="text-lg text-blue-100 leading-relaxed max-w-3xl">
              TendorAI tracks 72 SRA-registered solicitors in Bolton. <strong>19% have no website</strong> &mdash; making them completely invisible to ChatGPT, Gemini, and Perplexity. Here&apos;s what the data shows.
            </p>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 -mt-6">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 flex flex-col sm:flex-row items-center gap-6">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#1B4F72]">72</div>
              <div className="text-sm text-gray-500">SRA firms in Bolton</div>
            </div>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            <p className="text-lg text-gray-600 leading-relaxed mb-4">
              <strong className="text-gray-900">Bolton has 72 SRA-registered solicitors. 14 of them &mdash; 19% &mdash; have no website.</strong> Every single one of those firms is completely undetectable by ChatGPT, Gemini, and Perplexity.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              According to TendorAI&apos;s database of 8,625 SRA-registered solicitors across England and Wales, this is not unique to Bolton. But the data reveals a clear pattern: firms without structured digital infrastructure are being excluded from AI recommendations entirely.
            </p>
          </section>

          {/* Module 1: The Invisibility Problem */}
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">The Invisibility Problem: Bolton in Context</h2>

            <p className="text-gray-600 leading-relaxed mb-4">
              Of Bolton&apos;s 72 SRA-registered solicitors:
            </p>

            <ul className="space-y-2 mb-6">
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700"><strong>58 firms have a website</strong> &mdash; the minimum requirement to be detectable by AI</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700"><strong>14 firms have no website at all</strong> &mdash; 19% of all Bolton practices</span>
              </li>
              <li className="flex items-start gap-3">
              ...
              <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {nationalCityData.map((row, i) => (
                    <tr key={i} className={`${i % 2 === 0 ? 'bg-gray-50' : 'bg-white'} ${row.city === 'Bolton' ? 'ring-2 ring-[#1B4F72] ring-inset' : ''}`}>
                      <td className="p-3 text-gray-900 font-medium">{row.city === 'Bolton' ? <strong>{row.city}</strong> : row.city}</td>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">How AI Selects Which Bolton Solicitor to Recommend</h2>

            <p className="text-gray-600 leading-relaxed mb-6">
              When a potential client asks ChatGPT &ldquo;residential conveyancing solicitor Bolton,&rdquo; the AI does not browse a list of firms. It draws on indexed, structured data it has already processed.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Solicitors are better positioned than most regulated professions &mdash; accountants have near-universal web presence. But a website alone does not create AI visibility. Of the 58 Bolton solicitor firms with websites, the vast majority have no structured schema data, no AI-optimised content, and no mechanism for AI engines to verify their credentials.
            </p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What AI-Cited Bolton Firms Are Doing Differently</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What This Means for Bolton Solicitors in 2026</h2>

            <p className="text-gray-600 leading-relaxed mb-6">
              Three shifts are already underway that will accelerate AI&apos;s role in how clients find solicitors in Bolton:
            </p>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  AI engines rank firms based on declared identity &mdash; who they are, what they do, where they operate, what credentials they hold &mdash; not keyword density. SRA profile verification is emerging as a primary trust signal for Bolton law firms.
                </p>
              </div>
              ...
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Queries like &ldquo;residential conveyancing solicitor Bolton&rdquo; increasingly return a direct recommendation rather than a list of links. The firm recommended gets the enquiry. The firms not recommended are not seen.
                </p>
              </div>
              ...
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Perplexity has opened sponsored placements in the UK. ChatGPT&apos;s ad model is in development. Bolton firms with structured profiles already in place will be first in line. Firms without structured data cannot buy their way into these placements &mdash; the infrastructure has to exist first.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              When a potential client asks AI to recommend a solicitor in Bolton, TendorAI-listed firms have declared their credentials, location, services, and accreditations in machine-readable format. That is why they get recommended.
            </p>
          </section>
          ...
          <section className="bg-gradient-to-br from-[#1B4F72] to-[#2d1b4e] text-white rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-blue-100 mb-8 max-w-xl mx-auto">
              See where your Bolton firm stands in 60 seconds. We&apos;ll scan ChatGPT, Perplexity, and Gemini to show you exactly what AI knows about your practice.
            </p>
