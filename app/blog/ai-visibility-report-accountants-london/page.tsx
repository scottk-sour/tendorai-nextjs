...
const DESCRIPTION =
  'TendorAI tracks 412 accountancy firms in London. With 98% having websites, the real battle is structured data. Here\'s what AI visibility looks like for London accounting firms.';
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-gradient-to-br from-[#1B4F72] via-[#1a3d5c] to-[#2d1b4e] text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-lg text-blue-100 leading-relaxed max-w-3xl">
              Most London accountants have websites.<br />
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 -mt-6">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 flex flex-col sm:flex-row items-center gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">Accountancy firms in London</div>
            </div>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">TendorAI tracks 412 accountancy firms in London.</p>
            <ul className="space-y-1 mb-4">
              <li className="text-gray-700">&bull; 404 firms have a website</li>
              <li className="text-gray-700">&bull; 8 firms have no website</li>
            </ul>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">Across those 404 websites, the vast majority do not contain structured schema data.</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">This is not a London-only issue.</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-900 font-medium italic mb-4">&ldquo;Best chartered accountant in London for Making Tax Digital&rdquo;</p>
            ...
            <p className="text-gray-700">Most London firms only satisfy the first.</p>
          </section>
          ...
          {/* What This Means */}
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What This Means for London Accountants</h2>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">Out of 412 London accountants:</p>
