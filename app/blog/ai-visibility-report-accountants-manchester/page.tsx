...
const DESCRIPTION =
  'TendorAI tracks 89 accountancy firms in Manchester. Nearly all have websites but most lack the structured data AI needs to recommend them.';
...
const faqs = [
  ...
  },
  {
    ...
    a: 'TendorAI tracks 89 accountancy firms in Manchester. Only 2 have no website. However, having a website alone is not enough — the vast majority lack structured schema data, meaning even firms with websites are likely invisible to AI recommendation engines.',
  },
  {
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 -mt-6">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 flex flex-col sm:flex-row items-center gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">Accountancy firms in Manchester</div>
            </div>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">TendorAI tracks 89 accountancy firms in Manchester.</p>
