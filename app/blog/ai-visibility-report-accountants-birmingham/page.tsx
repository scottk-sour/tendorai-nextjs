...
const DESCRIPTION =
  'TendorAI tracks 74 accountancy firms in Birmingham. Most have websites but lack structured data for AI recommendations. Here\'s the full picture.';
...
const faqs = [
  ...
  },
  {
    ...
    a: 'TendorAI tracks 74 accountancy firms in Birmingham. 2 have no website. Of the remaining 72, the majority have no structured schema data \u2014 meaning even firms with websites are likely invisible to AI recommendation engines.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Traditional SEO optimises for keyword ranking in link-based search results. AI visibility (AI visibility \u2014 Answer Engine Optimisation) optimises for entity recognition in conversational AI responses. For accountants, this means declaring ICAEW or ACCA credentials, service areas, and specialisms in machine-readable format \u2014 not just mentioning them in page copy.',
  },
  {
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 -mt-6">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 flex flex-col sm:flex-row items-center gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">Accountancy firms in Birmingham</div>
            </div>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">TendorAI tracks 74 accountancy firms in Birmingham.</p>
