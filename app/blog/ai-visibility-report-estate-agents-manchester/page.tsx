...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. Traditional SEO optimises for keyword ranking in link-based search results. AI visibility optimises for entity recognition in conversational AI responses. For estate agents, this is especially critical because portal SEO has historically masked the need for independent web presence.',
  },
  {
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-gradient-to-br from-[#1B4F72] via-[#1a3d5c] to-[#2d1b4e] text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-lg text-blue-100 leading-relaxed max-w-3xl">
              Most Manchester estate agents rely on Rightmove.<br />
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">TendorAI tracks 95 estate agents in Manchester.</p>
            <ul className="space-y-1 mb-4">
              <li className="text-gray-700">&bull; 83 firms have a website</li>
              <li className="text-gray-700">&bull; 12 firms have no website</li>
            </ul>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">Most Manchester estate agents rely on Rightmove, Zoopla, and OnTheMarket.</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-900 font-medium italic mb-4">&ldquo;Best estate agent in Manchester to sell my house&rdquo;</p>
            ...
            <p className="text-gray-700">Most Manchester agencies only satisfy the first.</p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                <span className="font-bold text-[#1B4F72]">2.</span>
                <div><strong className="text-gray-900">Coverage areas as entities</strong> <span className="text-gray-600">&mdash; Didsbury, Chorlton, Sale, Altrincham &mdash; declared as structured data, not paragraph text</span></div>
              </div>
              <div className="flex gap-3">
                <span className="font-bold text-[#1B4F72]">3.</span>
          ...
          {/* What This Means */}
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What This Means for Manchester Estate Agents</h2>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">Out of 95 Manchester estate agents:</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">If you are an estate agent in Manchester, the question is simple:</p>
