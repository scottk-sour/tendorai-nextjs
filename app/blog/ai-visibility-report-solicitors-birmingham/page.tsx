...
const TITLE = 'AI Visibility Report: Birmingham Solicitors 2025 — TendorAI Research';
const DESCRIPTION =
  'TendorAI tracks 249 SRA-registered solicitors in Birmingham. 24% have no website. Here\'s what the data shows about AI visibility for Birmingham law firms.';
const CANONICAL = 'https://www.tendorai.com/blog/ai-visibility-report-solicitors-birmingham';
...
const faqs = [
  {
    q: 'Does my Birmingham firm appear when someone asks AI to recommend a solicitor?',
  ...
  {
    q: 'How many Birmingham solicitors are AI-visible?',
    a: 'TendorAI tracks 249 SRA-registered solicitors in Birmingham. 61 have no website. Of the remaining 188, the majority have no structured schema data — meaning even firms with websites are likely invisible to AI recommendation engines.',
  },
  {
  ...
  },
  {
    ...
    a: 'For high-intent queries ("find me a solicitor in Birmingham"), AI is already answering directly without returning links. According to industry data, AI Overviews now appear in over 60% of searches. Firms not visible in AI responses are missing an increasing share of inbound enquiries.',
  },
  {
...
export default function AIVisibilityReportBirminghamSolicitors() {
  ...
  const articleJsonLd = {
    ...
    keywords: [
      'AI visibility solicitors Birmingham',
      'Birmingham solicitors AI',
      'Birmingham law firm AI recommendations',
      'ChatGPT solicitor Birmingham',
      'AI visibility report Birmingham',
      'solicitor AI discovery Birmingham',
    ],
    wordCount: 2400,
    inLanguage: 'en-GB',
  };
        ...
        <section className="bg-gradient-to-br from-[#1B4F72] via-[#1a3d5c] to-[#2d1b4e] text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <nav className="text-sm mb-6 text-blue-200">
              ...
              <span className="mx-2">/</span>
              <span className="text-white">Birmingham Solicitors AI Visibility</span>
            </nav>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
              AI Visibility Report: Birmingham Solicitors 2025
            </h1>

            <p className="text-lg text-blue-100 leading-relaxed max-w-3xl">
              TendorAI tracks 249 SRA-registered solicitors in Birmingham. <strong>24% have no website</strong> &mdash; making them completely invisible to ChatGPT, Gemini, and Perplexity. Here&apos;s what the data shows.
            </p>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 -mt-6">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 flex flex-col sm:flex-row items-center gap-6">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#1B4F72]">249</div>
              <div className="text-sm text-gray-500">SRA firms in Birmingham</div>
            </div>
            <div className="h-px sm:h-12 sm:w-px bg-gray-200 w-full sm:w-auto" />
            <div className="text-center">
              <div className="text-4xl font-bold text-red-600">61</div>
              <div className="text-sm text-gray-500">with no website</div>
            </div>
            <div className="h-px sm:h-12 sm:w-px bg-gray-200 w-full sm:w-auto" />
            <div className="text-center">
              <div className="text-4xl font-bold text-amber-600">24%</div>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            <p className="text-lg text-gray-600 leading-relaxed mb-4">
              <strong className="text-gray-900">Birmingham has 249 SRA-registered solicitors. 61 of them &mdash; 24% &mdash; have no website.</strong> Every single one of those firms is completely undetectable by ChatGPT, Gemini, and Perplexity.
            </p>
          ...
          <section className="mb-12">
            ...
            <ul className="space-y-2 mb-6">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700"><strong>188 firms have a website</strong> &mdash; the minimum requirement to be detectable by AI</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700"><strong>61 firms have no website at all</strong> &mdash; 24% of all Birmingham practices</span>
              </li>
              <li className="flex items-start gap-3">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">How AI Selects Which Birmingham Solicitor to Recommend</h2>

            <p className="text-gray-600 leading-relaxed mb-6">
              When a potential client asks ChatGPT &ldquo;family solicitor Birmingham,&rdquo; the AI does not browse a list of firms. It draws on indexed, structured data it has already processed.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Solicitors are better positioned than most regulated professions &mdash; accountants have near-universal web presence. But a website alone does not create AI visibility. Of the 188 Birmingham solicitor firms with websites, the vast majority have no structured schema data, no AI-optimised content, and no mechanism for AI engines to verify their credentials.
            </p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What AI-Cited Birmingham Firms Are Doing Differently</h2>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  desc: `City, postcode, and coverage area are machine-readable. "We serve clients across the West Midlands" is useless to an AI engine. Structured address data with postcode and locality is not.`,
                },
                {
                  num: 3,
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What This Means for Birmingham Solicitors in 2026</h2>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  AI engines rank firms based on declared identity &mdash; who they are, what they do, where they operate, what credentials they hold &mdash; not keyword density. SRA profile verification is emerging as a primary trust signal for Birmingham law firms.
                </p>
              </div>
              ...
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Queries like &ldquo;family law solicitor Birmingham&rdquo; increasingly return a direct recommendation rather than a list of links. The firm recommended gets the enquiry. The firms not recommended are not seen.
                </p>
              </div>
