      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-gradient-to-br from-[#1B4F72] via-[#1a3d5c] to-[#2d1b4e] text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-lg text-blue-100 leading-relaxed max-w-3xl">
              Most Cardiff accountants have websites.<br />
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">Across those 44 websites, the vast majority do not contain structured schema data.</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-900 font-medium italic mb-4">&ldquo;Best chartered accountant in Cardiff for Making Tax Digital&rdquo;</p>
            ...
            <p className="text-gray-700">Most Cardiff firms only satisfy the first.</p>
          </section>
          ...
          {/* What This Means */}
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What This Means for Cardiff Accountants</h2>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">Out of 45 Cardiff accountants:</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 mb-2">If you are an accountant in Cardiff, the question is simple:</p>
