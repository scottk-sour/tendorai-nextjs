...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. Traditional SEO optimises for keyword ranking in link-based search results. AI visibility optimises for entity recognition in conversational AI responses. When a potential vendor asks ChatGPT "best estate agent in Birmingham," the AI does not return a list of links — it recommends specific agencies based on structured, verified data.',
  },
  {
