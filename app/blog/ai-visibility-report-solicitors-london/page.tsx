...
const faqs = [
  {
    q: 'Does my London firm appear when someone asks AI to recommend a solicitor?',
  ...
  {
    q: 'How many London solicitors are AI-visible?',
    a: 'TendorAI tracks 2,331 SRA-registered solicitors in London. 403 have no website. Of the remaining 1,928, the majority have no structured schema data — meaning even firms with websites are likely invisible to AI recommendation engines.',
  },
  {
  ...
  },
  {
    ...
    a: 'For high-intent queries ("find me a solicitor in London"), AI is already answering directly without returning links. According to industry data, AI Overviews now appear in over 60% of searches. Firms not visible in AI responses are missing an increasing share of inbound enquiries.',
  },
  {
...
export default function AIVisibilityReportLondonSolicitors() {
  ...
  const articleJsonLd = {
    ...
    keywords: [
      'AI visibility solicitors London',
      'London solicitors AI',
      'London law firm AI recommendations',
      'ChatGPT solicitor London',
      'AI visibility report London',
      'solicitor AI discovery London',
    ],
    wordCount: 2400,
    inLanguage: 'en-GB',
  };
        ...
        <section className="bg-gradient-to-br from-[#1B4F72] via-[#1a3d5c] to-[#2d1b4e] text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <nav className="text-sm mb-6 text-blue-200">
              ...
              <span className="mx-2">/</span>
              <span className="text-white">London Solicitors AI Visibility</span>
            </nav>
            ...
            <p className="text-lg text-blue-100 leading-relaxed max-w-3xl">
              TendorAI tracks 2,331 SRA-registered solicitors in London. <strong>17% have no website</strong> &mdash; making them completely invisible to ChatGPT, Gemini, and Perplexity. Here&apos;s what the data shows.
            </p>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 -mt-6">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 flex flex-col sm:flex-row items-center gap-6">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#1B4F72]">2,331</div>
              <div className="text-sm text-gray-500">SRA firms in London</div>
            </div>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            <p className="text-lg text-gray-600 leading-relaxed mb-4">
              <strong className="text-gray-900">London has 2,331 SRA-registered solicitors. 403 of them &mdash; 17% &mdash; have no website.</strong> Every single one of those firms is completely undetectable by ChatGPT, Gemini, and Perplexity.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              According to TendorAI&apos;s database of 8,625 SRA-registered solicitors across England and Wales, this is not unique to London. But the data reveals a clear pattern: firms without structured digital infrastructure are being excluded from AI recommendations entirely.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Of London&apos;s 2,331 SRA-registered solicitors:
            </p>

            <ul className="space-y-2 mb-6">
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700"><strong>1,928 firms have a website</strong> &mdash; the minimum requirement to be detectable by AI</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700"><strong>403 firms have no website at all</strong> &mdash; 17% of all London practices</span>
              </li>
              <li className="flex items-start gap-3">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">How AI Selects Which London Solicitor to Recommend</h2>

            <p className="text-gray-600 leading-relaxed mb-6">
              When a potential client asks ChatGPT &ldquo;commercial property solicitor in London,&rdquo; the AI does not browse a list of firms. It draws on indexed, structured data it has already processed.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Solicitors are better positioned than most regulated professions &mdash; accountants have near-universal web presence. But a website alone does not create AI visibility. Of the 1,928 London solicitor firms with websites, the vast majority have no structured schema data, no AI-optimised content, and no mechanism for AI engines to verify their credentials.
            </p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What AI-Cited London Firms Are Doing Differently</h2>

            <p className="text-gray-600 leading-relaxed mb-6">
              TendorAI&apos;s analysis of firms across London boroughs that appear consistently in AI recommendation results identifies four common factors:
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  desc: `City, postcode, and coverage area are machine-readable. "We serve clients across London boroughs" is useless to an AI engine. Structured address data with postcode and locality is not.`,
                },
                {
                  num: 3,
                  title: 'Service clarity',
                  desc: `Practice areas are listed as structured entities, not paragraph text. An AI cannot reliably extract "we specialise in commercial property" from a homepage. Schema-declared services are unambiguous.`,
                },
                {
                  num: 4,
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What This Means for London Solicitors in 2026</h2>

            <p className="text-gray-600 leading-relaxed mb-6">
              Three shifts are already underway that will accelerate AI&apos;s role in how clients find solicitors in London:
            </p>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  AI engines rank firms based on declared identity &mdash; who they are, what they do, where they operate, what credentials they hold &mdash; not keyword density. SRA profile verification is emerging as a primary trust signal for London law firms.
                </p>
              </div>
              ...
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Queries like &ldquo;commercial property solicitor London&rdquo; increasingly return a direct recommendation rather than a list of links. The firm recommended gets the enquiry. The firms not recommended are not seen.
                </p>
              </div>
              ...
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Perplexity has opened sponsored placements in the UK. ChatGPT&apos;s ad model is in development. London firms with structured profiles already in place will be first in line. Firms without structured data cannot buy their way into these placements &mdash; the infrastructure has to exist first.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              When a potential client asks AI to recommend a solicitor in London, TendorAI-listed firms have declared their credentials, location, services, and accreditations in machine-readable format. That is why they get recommended.
            </p>
          </section>
          ...
          <section className="bg-gradient-to-br from-[#1B4F72] to-[#2d1b4e] text-white rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-blue-100 mb-8 max-w-xl mx-auto">
              See where your London firm stands in 60 seconds. We&apos;ll scan ChatGPT, Perplexity, and Gemini to show you exactly what AI knows about your practice.
            </p>
