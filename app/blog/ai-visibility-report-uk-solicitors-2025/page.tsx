...
const TITLE = 'AI Visibility Report: UK Solicitors 2026';
const DESCRIPTION =
...
const faqs = [
  {
    q: 'Does my firm appear when someone asks AI to recommend a solicitor?',
  ...
  {
    q: 'How many Cardiff solicitors are AI-visible?',
    a: 'TendorAI tracks 81 SRA-registered solicitors in Cardiff. 17 have no website. Of the remaining 64, the majority have no structured schema data — meaning even firms with websites are likely invisible to AI recommendation engines.',
  },
  {
  ...
  },
  {
    ...
    a: 'For high-intent queries ("find me a solicitor in [city]"), AI is already answering directly without returning links. According to industry data, AI Overviews now appear in over 60% of searches. Firms not visible in AI responses are missing an increasing share of inbound enquiries.',
  },
  {
...
export default function AIVisibilityReportSolicitors() {
  ...
  const articleJsonLd = {
    ...
    keywords: [
      ...
      'SRA solicitors AI',
      'law firm AI recommendations',
      'ChatGPT solicitor visibility',
      'UK solicitors data report',
      'AI visibility report 2026',
      'solicitor AI discovery',
    ],
    wordCount: 2400,
    inLanguage: 'en-GB',
  };
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="bg-gradient-to-br from-[#1B4F72] via-[#1a3d5c] to-[#2d1b4e] text-white py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <nav className="text-sm mb-6 text-blue-200">
              ...
              <span className="mx-2">/</span>
              <span className="text-white">AI Visibility Report</span>
            </nav>
            ...
            <p className="text-lg text-blue-100 leading-relaxed max-w-3xl">
              1,458 SRA-registered law firms have no website. Every single one of them is invisible to ChatGPT, Gemini, and Perplexity. This report shows what the data reveals &mdash; and what it means for every solicitor in the UK.
            </p>

            <div className="mt-6 flex items-center gap-4 text-sm text-blue-200">
              <span>By TendorAI</span>
              <span>&middot;</span>
              <span>Published 21 March 2026</span>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 -mt-6">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 flex flex-col sm:flex-row items-center gap-6">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#1B4F72]">8,625</div>
              <div className="text-sm text-gray-500">SRA firms tracked</div>
            </div>
            <div className="h-px sm:h-12 sm:w-px bg-gray-200 w-full sm:w-auto" />
            <div className="text-center">
              <div className="text-4xl font-bold text-red-600">1,458</div>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">The Invisibility Problem: What TendorAI&apos;s Data Shows</h2>
            ...
            <ul className="space-y-2 mb-6">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700"><strong>7,167 firms have a website</strong> &mdash; the minimum requirement to be detectable by AI</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700"><strong>1,458 firms have no website at all</strong> &mdash; 17% of all SRA-registered practices</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-amber-500 rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700">In Cardiff specifically, <strong>21% of registered solicitors have no web presence</strong></span>
              </li>
            </ul>
                ...
                <tbody>
                  {cityData.map((row, i) => (
                    <tr key={i} className={i % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                      <td className="p-3 text-gray-900 font-medium">{row.city}</td>
          ...
          {/* Module 1: How AI Selects */}
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">How AI Selects Which Solicitor to Recommend</h2>

            <p className="text-gray-600 leading-relaxed mb-6">
              When a potential client asks ChatGPT &ldquo;find me a conveyancing solicitor in Bristol with fixed fees,&rdquo; the AI does not browse a list of firms. It draws on indexed, structured data it has already processed.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Solicitors are better positioned than most regulated professions &mdash; accountants have near-universal web presence. But a website alone does not create AI visibility. Of the 7,167 solicitor firms with websites, the vast majority have no structured schema data, no AI-optimised content, and no mechanism for AI engines to verify their credentials.
            </p>
          ...
          {/* Module 3: What AI-Cited Firms Do Differently */}
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What AI-Cited Firms Are Doing Differently</h2>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  desc: 'City, postcode, and coverage area are machine-readable. "We serve clients across the South West" is useless to an AI engine. "addressLocality": "Bristol", "postalCode": "BS1 4QS" is not.',
                },
                {
                  num: 3,
                  title: 'Service clarity',
                  desc: 'Practice areas are listed as structured entities, not paragraph text. An AI cannot reliably extract "we specialise in residential conveyancing and family law" from a homepage. Schema-declared services are unambiguous.',
                },
                {
                  num: 4,
          ...
          {/* Module 4: Cardiff Case Study */}
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">The Cardiff Case Study</h2>

            <p className="text-gray-600 leading-relaxed mb-4">
              Gemini&apos;s response to &ldquo;best conveyancing solicitor Cardiff 2026&rdquo; cited three sources: CJCH Solicitors&apos; own award page, Trustpilot, and Wales 247.
            </p>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-5 mb-6">
              <ul className="space-y-2">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-700">They won a named, datable award (Conveyancing Firm of the Year &mdash; Wales 2025)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 font-bold mt-0.5">&#10003;</span>
                  <span className="text-sm text-gray-700">They published content about it on their own domain</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 font-bold mt-0.5">&#10003;</span>
                  <span className="text-sm text-gray-700">That content was indexed, structured, and citable</span>
                </li>
              </ul>
            </div>

            <p className="text-gray-600 leading-relaxed mb-4">
              The other 80 Cardiff firms were not recommended &mdash; not because they are worse solicitors, but because they gave AI engines nothing to cite.
            </p>

            <div className="bg-gray-900 text-white rounded-xl p-6">
              <p className="text-sm leading-relaxed text-gray-200">
                <strong className="text-white">This is the entire problem in one example.</strong> AI does not discover the best firm. It recommends the most citable firm.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What Changes in 2026</h2>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  AI engines rank firms based on declared identity &mdash; who they are, what they do, where they operate, what credentials they hold &mdash; not keyword density. SRA profile verification is emerging as a primary trust signal.
                </p>
              </div>
              ...
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Queries like &ldquo;employment solicitor Manchester&rdquo; increasingly return a direct recommendation rather than a list of links. The firm recommended gets the enquiry. The firms not recommended are not seen.
                </p>
              </div>
              ...
              <div className="border-l-4 border-[#1B4F72] pl-5">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Perplexity has opened sponsored placements in the UK. ChatGPT&apos;s ad model is in development. Firms with structured profiles already in place will be first in line. Firms without structured data cannot buy their way into these placements &mdash; the infrastructure has to exist first.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-br from-[#1B4F72] to-[#2d1b4e] text-white rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-blue-100 mb-8 max-w-xl mx-auto">
              See where your firm stands in 60 seconds. We&apos;ll scan ChatGPT, Perplexity, and Gemini to show you exactly what AI knows about your practice.
            </p>
