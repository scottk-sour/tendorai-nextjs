...
export const TIER_CONFIG = {
  pro: {
    ...
    color: 'green',
    badge: 'Verified',
    description: 'Get recommended first. Full structured data, weekly AI Visibility reports, AI mention tracking, TendorAI Verified badge, and priority ranking in AI results.',
    features: [
