...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    price: 299,
    priceLabel: '£299/mo',
    description: 'We install AI-optimised data on your website, track your AI visibility weekly, and verify your profile.',
    features: [
      ...
      { text: 'Weekly AI-optimised articles written for your firm — integrity-checked and approved by you before publishing', included: true },
