...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Schema.org installed on your website by our team', included: true },
      { text: 'Two-way AI trust link between your site and TendorAI', included: true },
      { text: 'Google Business Profile optimisation checklist', included: true },
      { text: 'Auto-syncing structured data (update TendorAI, your site updates too)', included: true },
